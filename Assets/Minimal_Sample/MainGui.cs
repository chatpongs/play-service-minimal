...
public class MainGui : MonoBehaviour {
    ...
    void OnGUI() {
		...
		if (PlayGamesPlatform.Instance.localUser.authenticated) 
		{
			...
			if (PlayGamesPlatform.Instance.localUser.image != null) 
			{
				GUI.DrawTexture(imageRect, PlayGamesPlatform.Instance.localUser.image, ScaleMode.ScaleToFit);
        	} 
			else 
			{
        ...
        if (GUI.Button(buttonRect, buttonLabel)) 
		{
			if (!PlayGamesPlatform.Instance.localUser.authenticated) 
			{
				...
				PlayGamesPlatform.Instance.localUser.Authenticate((bool success) => {
                    ...
                    if (success) 
					{
						mStatusText = "Welcome " + PlayGamesPlatform.Instance.localUser.userName;
                    } 
					else 
					{
